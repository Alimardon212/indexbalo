    ...
    return (function(CanvasKitInit) {
        ...
        (function(a) {
            ...
            a.Vd.push(function() {
                a.MakeSWCanvasSurface = function(b) {
                    var d = b;
                    if ("CANVAS" !== d.tagName && (d = document.getElementById(b),
                    !d))
            ...
            a.Vd.push(function() {
                ...
                a.MakeRenderTarget = function() {
                    ...
                    if (3 === arguments.length) {
                        ...
                        if (q = this._MakeRenderTargetII(n, arguments[1]),
                        !q)
                            return null
                    } else
                        return null;
                ...
                a.MakeWebGLCanvasSurface = function(n, q, v) {
                    ...
                    if (!("undefined" !== typeof HTMLCanvasElement && D instanceof HTMLCanvasElement || I || (D = document.getElementById(n),
                    D)))
                ...
                a.Surface.prototype.makeImageFromTextureSource = function(n, q, v) {
                    ...
                    2 === x.version ? D.texImage2D(D.TEXTURE_2D, 0, D.RGBA, q.width, q.height, 0, D.RGBA, D.UNSIGNED_BYTE, n) : D.texImage2D(D.TEXTURE_2D, 0, D.RGBA, D.RGBA, D.UNSIGNED_BYTE, n);
                    u(D, q);
                ...
                a.MakeLazyImageFromTextureSource = function(n, q, v) {
                    ...
                    var D = {
                        makeTexture: function() {
                            ...
                            2 === I.version ? M.texImage2D(M.TEXTURE_2D, 0, M.RGBA, q.width, q.height, 0, M.RGBA, M.UNSIGNED_BYTE, n) : M.texImage2D(M.TEXTURE_2D, 0, M.RGBA, M.RGBA, M.UNSIGNED_BYTE, n);
                            u(M, q, v);
                            return d(z)
                        },
                        freeSrc: function() {}
        ...
        (function(a) {
            ...
            a.parseColorString = function(e, c) {
                ...
                e = e.split(","),
                a.Color(+e[0], +e[1], +e[2], u(e[3]))) : e.startsWith("gray(") || e.startsWith("hsl") || !c || (e = c[e],
                void 0 === e) ? a.BLACK : e
            }
            ;
            ...
            a.onRuntimeInitialized = function() {
                function e(c, g, l, r, y, C, J) {
                    ...
                    if (J ? !c._readPixels(r, O, C, g, l, J) : !c._readPixels(r, O, C, g, l))
                        return y || a._free(O),
                        null;
                    if (y)
                ...
                a.Path.prototype.addPath = function() {
                    ...
                    if (1 === c.length)
                        ...
                        c = c[1],
                        this._addPath(g, c[0], c[1], c[2], c[3], c[4], c[5], c[6] || 0, c[7] || 0, c[8] || 1, l);
                ...
                a.getShadowLocalBounds = function(c, g, l, r, y, C, J) {
                    ...
                    l = v(l, "HEAPF32", Yb);
                    r = v(r, "HEAPF32", Zb);
                    if (!this._getShadowLocalBounds(c, g, l, r, y, C, ja))
                        return null;
                    g = Ha.toTypedArray();
                    return J ? (J.set(g),
                    J) : g.slice()
            ...
            a.ColorMatrix.concat = function(e, c) {
                for (var g = new Float32Array(20), l = 0, r = 0; 20 > r; r += 5) {
                    for (var y = 0; 4 > y; y++)
                        g[l++] = e[r] * c[y] + e[r + 1] * c[y + 5] + e[r + 2] * c[y + 10] + e[r + 3] * c[y + 15];
            ...
            (function(e) {
                ...
                e.Vd.push(function() {
                    ...
                    function y(t) {
                        ...
                        Array.isArray(t.fontFamilies) && t.fontFamilies.length ? (t._fontFamiliesPtr = l(t.fontFamilies),
                        t._fontFamiliesLen = t.fontFamilies.length) : (t._fontFamiliesPtr = V,
                        ...
                        Array.isArray(t.fontFeatures) && t.fontFeatures.length ? (F = t.fontFeatures,
                        P = F.map(function(ba) {
                            return ba.name
                        }),
                        X = F.map(function(ba) {
                        ...
                        t._fontFeatureValuesPtr = v(X, "HEAPU32")) : (t._fontFeatureLen = 0,
                        t._fontFeatureNamesPtr = V,
                        t._fontFeatureValuesPtr = V);
                        Array.isArray(t.fontVariations) && t.fontVariations.length ? (F = t.fontVariations,
                        P = F.map(function(ba) {
                            return ba.axis
                        }),
                        X = F.map(function(ba) {
                        ...
                        t._fontVariationValuesPtr = v(X, "HEAPF32")) : (t._fontVariationLen = 0,
                    ...
                    e.ParagraphStyle = function(t) {
                        ...
                        F.strutEnabled && Array.isArray(F.fontFamilies) && F.fontFamilies.length ? (F._fontFamiliesPtr = l(F.fontFamilies),
                        F._fontFamiliesLen = F.fontFamilies.length) : (F._fontFamiliesPtr = V,
                    ...
                    e.ParagraphBuilder.prototype.buildWithClientInfo = function(t, F, P, X) {
                        var ia = v(t, "HEAPU32")
                          ...
                          , qa = v(P, "HEAPU32")
                          , sa = v(X, "HEAPU32")
                          , ba = this._buildWithClientInfo(ia, t && t.length || 0, la, F && F.length || 0, qa, P && P.length || 0, sa, X && X.length || 0);
                        q(ia, t);
                        q(la, F);
                        q(qa, P);
                        q(sa, X);
            ...
            (function() {
                ...
                function r(H) {
                    ...
                    this.bezierCurveTo = function(k, p, A, B, E, G) {
                        var L = this.Sd;
                        e([k, p, A, B, E, G]) && (L.isEmpty() && L.moveTo(k, p),
                        L.cubicTo(k, p, A, B, E, G))
                    }
                    ;
                    ...
                    this.quadraticCurveTo = function(k, p, A, B) {
                        var E = this.Sd;
                        e([k, p, A, B]) && (E.isEmpty() && E.moveTo(k, p),
                        E.quadTo(k, p, A, B))
                    }
                    ;
                ...
                function t(H, k, p, A, B, E, G) {
                    ...
                    1E-5 > Math.abs(Math.abs(G) - 360) ? (p = G / 2,
                    H.arcToOval(k, E, p, !1),
                    H.arcToOval(k, E + p, p, !1)) : H.arcToOval(k, E, G, !1)
                }
                function F(H, k, p, A, B, E, G, L, ca) {
                    if (e([k, p, A, B, E, G, L])) {
                        ...
                        E ? (ca = a.Matrix.rotated(E, k, p),
                        E = a.Matrix.rotated(-E, k, p),
                        H.transform(E),
                        t(H, k, p, A, B, G, L),
                        H.transform(ca)) : t(H, k, p, A, B, G, L)
                    }
                }
                function P(H, k, p) {
                    e([k, p]) && (H.isEmpty() && H.moveTo(k, p),
                    H.lineTo(k, p))
                }
                function X(H) {
                    this.Wd = null;
        ...
        , xa = "object" == typeof window, ya = "function" == typeof importScripts, za = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node, Aa = "", Ba, Ca, Da, fs, Ea, Fa;
        if (za)
        ...
        function Ta(a, b, d) {
            ...
            for (d = b; a[d] && !(d >= f); )
                ++d;
            if (16 < d - b && a.buffer && Sa)
                return Sa.decode(a.subarray(b, d));
            for (f = ""; b < d; ) {
                var h = a[b++];
                if (h & 128) {
                    var m = a[b++] & 63;
        ...
        function Xa(a, b) {
            var d = a >> 1;
            for (var f = d + b / 2; !(d >= f) && Ya[d]; )
                ++d;
            d <<= 1;
            if (32 < d - a && Wa)
                return Wa.decode(K.subarray(a, d));
            d = "";
            for (f = 0; !(f >= b / 2); ++f) {
                var h = Za[a + 2 * f >> 1];
                if (0 == h)
        ...
        function Pb(a, b, d) {
            ...
            var h = Array(b.length)
              ...
              , u = 0;
            b.forEach( (n, q) => {
                Ib.hasOwnProperty(n) ? h[q] = Ib[n] : (m.push(n),
        ...
        function qc(a, b, d) {
            w.hasOwnProperty(a) ? ((void 0 === d || void 0 !== w[a].Zd && void 0 !== w[a].Zd[d]) && Y("Cannot register public name '" + a + "' twice"),
            pc(w, a, a),
        ...
        function sc(a, b, d) {
            for (; b !== d; )
                b.Oe || Y("Expected null or instance of " + d.name + ", got an instance of " + b.name),
                a = b.Oe(a),
                b = b.ie;
            return a
        }
        function tc(a, b) {
            if (null === b)
                return this.ff && Y("null is not a valid " + this.name),
                0;
        ...
        function vc(a, b) {
            ...
            if (this.Te)
                switch (void 0 === b.Ld.$d && Y("Passing raw pointer to smart pointer is illegal"),
                this.hg) {
                case 0:
        ...
        function yc(a, b, d, f, h, m, u, n, q, v, D) {
            ...
            this.cg = v;
            this.le = D;
            h || void 0 !== b.ie ? this.toWireType = vc : (this.toWireType = f ? tc : xc,
            this.ee = null)
        }
        function zc(a, b, d) {
            w.hasOwnProperty(a) || Ob("Replacing nonexistant public symbol");
            void 0 !== w[a].Zd && void 0 !== d ? w[a].Zd[d] = b : (w[a] = b,
            w[a].De = d)
        }
        function Ac(a, b) {
            var d = [];
        ...
        function Mc(a, b) {
            function d(m) {
                h[m] || Ib[m] || (Jb[m] ? Jb[m].forEach(d) : (f.push(m),
                h[m] = !0))
            }
            var f = []
              , h = {};
        ...
        function Nc(a, b, d, f, h) {
            ...
            return function() {
                ...
                for (var N = 0; N < v; ++N)
                    D[N] = b[N + 2].toWireType(M, arguments[N]),
                    I.push(D[N]);
                N = f.apply(null, I);
                if (n)
                    Fb(M);
        ...
        function fa(a) {
            for (var b = kd++, d = a.length; d < b; d++)
                a[d] = null;
            return b
        }
        function ka(a, b) {
            a.lf || (a.lf = a.getContext,
        ...
        function Ud(a, b, d, f) {
            ...
            function q(z) {
                ...
                for (z = new Date((new Date(z.qe + 1900,0,1)).getTime()); 0 < N; ) {
                    ...
                    if (N > U - z.getDate())
                        N -= U - z.getDate() + 1,
                        z.setDate(1),
                        11 > T ? z.setMonth(T + 1) : (z.setMonth(0),
            ...
            for (var D in v)
                d = d.replace(new RegExp(D,"g"), v[D]);
        ...
        w.getLiveInheritedInstances = function() {
            var a = [], b;
            for (b in kc)
                kc.hasOwnProperty(b) && a.push(kc[b]);
            return a
        }
        ;
        ...
        yc.prototype.fromWireType = function(a) {
            ...
            return null === h ? b.call(this) : this.Te ? mc(f.Rd.Ge, {
                Xd: f,
                Td: h,
                fe: this,
                $d: a
        ...
        var pe = {
            ...
            o: function(a, b, d, f, h, m, u, n, q, v, D, I, M) {
                ...
                Pb([a, b, d], f ? [f] : [], function(N) {
                    ...
                    N = Lb(z, function() {
                        ...
                        if (void 0 === hb)
                            throw new ac("Tried to invoke ctor of " + D + " with invalid number of parameters (" + arguments.length + ") - expected (" + Object.keys(va.oe).toString() + ") parameters instead!");
                        return hb.apply(this, arguments)
                    });
                    var ra = Object.create(U, {
                        constructor: {
                            value: N
                        }
                    });
            ...
            b: function(a, b, d, f, h, m, u, n) {
                ...
                Pb([], [a], function(v) {
                    ...
                    var M = v.Rd.Ge
                      , z = M[b];
                    void 0 === z || void 0 === z.Zd && z.className !== v.name && z.De === d - 2 ? (D.De = d - 2,
                    D.className = v.name,
                    M[b] = D) : (pc(M, b, I),
                    M[b].Zd[d - 2] = D);
                    Pb([], q, function(N) {
                        N = Nc(I, N, v, m, u);
                        void 0 === M[b].Zd ? (N.De = d - 2,
                        M[b] = N) : M[b].Zd[d - 2] = N;
                        return []
                    });
                    return []
                ...
                Qb(a, {
                    ...
                    fromWireType: function(q) {
                        for (var v = lb[q >> 2], D = u(), I, M = q + 4, z = 0; z <= v; ++z) {
                            ...
                            if (z == v || 0 == D[N >> n])
                                M = f(M, N - M),
                                void 0 === I ? I = M : (I += String.fromCharCode(0),
                                I += M),
                                M = N + b
                        }
                        Lc(q);
            ...
            ia: function(a, b, d, f) {
                2 <= x.version ? d && b ? Z.bufferData(a, K, f, d, b) : Z.bufferData(a, b, f) : Z.bufferData(a, d ? K.subarray(d, d + b) : b, f)
            },
            ja: function(a, b, d, f) {
            ...
            ma: function(a, b, d, f, h, m, u, n) {
                2 <= x.version ? Z.Ee || !u ? Z.compressedTexImage2D(a, b, d, f, h, m, u, n) : Z.compressedTexImage2D(a, b, d, f, h, m, K, n, u) : Z.compressedTexImage2D(a, b, d, f, h, m, n ? K.subarray(n, n + u) : null)
            },
            ...
            Xb: function(a, b) {
                return (a = Z.fenceSync(a, b)) ? (b = fa(sd),
                a.name = b,
                sd[b] = a,
                b) : 0
            },
            ...
            Ma: function(a, b, d) {
                if (d)
                    ...
                    35716 == b)
                        ...
                        R[d >> 2] = Z.getProgramParameter(a, b);
                else
                    wd(1281)
            },
            dc: function(a, b, d) {
            ...
            Oa: function(a, b, d) {
                d ? 35716 == b ? (a = Z.getShaderInfoLog(pd[a]),
                null === a && (a = "(unknown error)"),
                R[d >> 2] = a ? a.length + 1 : 0) : 35720 == b ? (a = Z.getShaderSource(pd[a]),
            ...
            jb: function(a, b) {
                ...
                var d = ud[a];
                if (d)
                    return 0 > b || b >= d.length ? (wd(1281),
                    0) : d[b];
                switch (a) {
                case 7939:
                    return d = Z.getSupportedExtensions() || [],
            ...
            Pa: function(a, b) {
                ...
                if (a = md[a]) {
                    ...
                    if (!f)
                        for (d.Ne = f = {},
                        d.wf = {},
                        m = 0; m < Z.getProgramParameter(d, 35718); ++m) {
                    ...
                    h = b.slice(0, m));
                    if ((h = a.xf[h]) && f < h[0] && (f += h[1],
                    d[f] = d[f] || Z.getUniformLocation(a, b)))
                        return f
                } else
                    wd(1281);
                return -1
            ...
            Ua: function(a, b, d, f, h, m, u) {
                if (2 <= x.version)
                    ...
                    (u = Jd(m, h, d, f, u)) ? Z.readPixels(a, b, d, f, h, m, u) : wd(1280)
            },
            ec: function(a, b, d, f) {
            ...
            bb: function(a, b, d, f, h, m, u, n, q) {
                if (2 <= x.version)
                    if (Z.Ee)
                        Z.texImage2D(a, b, d, f, h, m, u, n, q);
                    else if (q) {
                        var v = Id(n);
                        Z.texImage2D(a, b, d, f, h, m, u, n, v, q >> 31 - Math.clz32(v.BYTES_PER_ELEMENT))
                    } else
                        Z.texImage2D(a, b, d, f, h, m, u, n, null);
                else
                    Z.texImage2D(a, b, d, f, h, m, u, n, q ? Jd(n, u, f, h, q) : null)
            },
            cb: function(a, b, d) {
            ...
            gb: function(a, b, d, f, h, m, u, n, q) {
                if (2 <= x.version)
                    if (Z.Ee)
                        Z.texSubImage2D(a, b, d, f, h, m, u, n, q);
                    else if (q) {
                        var v = Id(n);
                        Z.texSubImage2D(a, b, d, f, h, m, u, n, v, q >> 31 - Math.clz32(v.BYTES_PER_ELEMENT))
                    } else
                        Z.texSubImage2D(a, b, d, f, h, m, u, n, null);
                else
                    v = null,
                    q && (v = Jd(n, u, h, m, q)),
            ...
            _c: function(a, b, d) {
                if (2 <= x.version)
                    b && Z.uniform1iv(Kd(a), R, d >> 2, b);
                else {
                    if (288 >= b)
                        for (var f = Md[b - 1], h = 0; h < b; ++h)
                            f[h] = R[d + 4 * h >> 2];
                    else
                        f = R.subarray(d >> 2, d + 4 * b >> 2);
                    Z.uniform1iv(Kd(a), f)
                }
            },
            $c: function(a, b, d) {
        ...
        (function() {
            ...
            if (w.instantiateWasm)
                try {
                    ...
                    return Ja("Module.instantiateWasm callback failed with error: " + h),
                    !1
                }
            (function() {
                return Ma || "function" != typeof WebAssembly.instantiateStreaming || wb() || yb.startsWith("file://") || za || "function" != typeof fetch ? d(b) : fetch(yb, {
                    credentials: "same-origin"
                }).then(function(h) {
            ...
            if (!(0 < tb)) {
                if (w.preRun)
                    for ("function" == typeof w.preRun && (w.preRun = [w.preRun]); w.preRun.length; )
                        sb();
                Cb(pb);
                0 < tb || (w.setStatus ? (w.setStatus("Running..."),
                setTimeout(function() {
                    setTimeout(function() {
                        w.setStatus("")
                    }, 1);
